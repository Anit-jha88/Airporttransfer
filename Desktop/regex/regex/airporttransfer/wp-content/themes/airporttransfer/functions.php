...
function mytheme_custom_styles() {
	...
	//wp_enqueue_style( 'custom-style1', get_template_directory_uri() . '/css/brands.css' );
	//wp_enqueue_style( 'custom-style2', get_template_directory_uri() . '/css/fontawesome.css' );
	//wp_enqueue_style( 'custom-style3', get_template_directory_uri() . '/css/regular.css' );
	//wp_enqueue_style( 'custom-style4', get_template_directory_uri() . '/css/solid.css' );
	//wp_enqueue_style( 'custom-style5', get_template_directory_uri() . '/css/bootstrap.css' );
	//wp_enqueue_style( 'custom-style6', get_template_directory_uri() . '/css/slick.css' );
	//wp_enqueue_style( 'custom-style7', get_template_directory_uri() . '/css/jquery.fancybox.min.css' );
	//wp_enqueue_style( 'custom-style8', get_template_directory_uri() . '/css/bootstrap.css' );
	//wp_enqueue_style( 'custom-style9', get_template_directory_uri() . '/style.css' );
	//wp_enqueue_style( 'custom-style10', get_template_directory_uri() . '/responsive.css' );
...
//wp_enqueue_script( 'myscript2', get_template_directory_uri() . '/js/bootstrap.js', array(), false, true );
//wp_enqueue_script( 'myscript3', get_template_directory_uri() . '/js/slick.min.js', array(), false, true );
//wp_enqueue_script( 'myscript4', get_template_directory_uri() . '/js/popper.min.js', array(), false, true );	
//wp_enqueue_script( 'myscript5', get_template_directory_uri() . '/js/jquery.fancybox.min.js', array(), false, true );	
//wp_enqueue_script( 'myscript6', get_template_directory_uri() . '/js/common.js', array(), false, true );	
...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Product Cms Settings',
		'menu_title'	=> 'Product Content',
		'parent_slug'	=> 'theme-general-settings',
	));
